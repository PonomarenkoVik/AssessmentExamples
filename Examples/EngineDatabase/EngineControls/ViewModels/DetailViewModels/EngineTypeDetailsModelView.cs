...
{
    public class EngineTypeDetailsModelView : DetailViewModelBase<EngineTypeWrapper, EngineType>
    {
        public EngineTypeDetailsModelView(IRepositories repositories, IMessageDialogService messageDialogService, IEventAggregator eventAggregator) : base(repositories, messageDialogService, eventAggregator)
        {
        }
